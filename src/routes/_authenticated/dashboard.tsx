...
const NICHOS: Record<string, string[]> = {
  ...
  "Marketing Digital": [
    ...
    "Infoprodutos do Zero",
  ],
  "Redes Sociais": [
    "Crescer no Instagram",
    "Crescer no TikTok",
    "Reels Virais",
    "Canal no YouTube do Zero",
    "Shorts Lucrativos",
    "Threads e X (Twitter)",
    "LinkedIn para Profissionais",
    "Pinterest para Tráfego",
    "Gestão de Redes Sociais",
    "Edição de Vídeo no Celular",
    "Storytelling para Posts",
    "Branding Pessoal",
  ],
  ...
  Beleza: [
    ...
    "Beleza Natural",
    "Cabelos Cacheados",
    "Cabelos Lisos Saudáveis",
    "Transição Capilar",
    "Maquiagem para Iniciantes",
    "Automaquiagem para Eventos",
    "Unhas em Casa",
  ...
  "Design e Criatividade": [
    "Design Gráfico no Canva",
    "Photoshop do Zero",
    "Illustrator para Logos",
    "Identidade Visual",
    "UX/UI Design",
    "Design de Apresentações",
    "Edição de Vídeo no Premiere",
    "Edição de Vídeo no CapCut",
    "Motion Graphics",
  ...
  "Escrita e Conteúdo": [
    "Escrever um Livro",
    "Autopublicação no Kindle",
    "Roteiro para YouTube",
    "Copywriting para Anúncios",
    "Storytelling",
    "Blog que Lucra",
    "Newsletter Lucrativa",
    "Ghostwriting",
    "Revisão e Português Prático",
    "Poesia Moderna",
    "Crônicas e Contos",
    "Audiolivros",
  ],
  ...
  "Jogos e Entretenimento": [
    ...
    "Streaming na Twitch",
    "Edição para Cortes",
    "Free Fire Competitivo",
    "League of Legends",
    "Valorant Ranqueado",
    "Minecraft Criativo",
    "Roblox para Crianças",
    "Xadrez do Zero",
    "RPG de Mesa",
    "Cosplay",
    "Cinema e Séries",
